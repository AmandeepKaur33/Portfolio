...
const Home = () => {
  return (
    <div className='relative w-full h-screen  flex items-center justify-between px-8 md:px-20 bg-white'>
    {/* Left Content */}
    <div className="z-10 max-w-4xl px-20">
    ...
    <div className="absolute right-0 top-0 w-[60vw]  h-full overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
           Building seamless web experiences 🚀 Crafting modern, responsive interfaces 💻 Designing intuitive and engaging user experiences 🌐 Developing reusable and scalable UI components ⚡
          </motion.textPath>
        </motion.text>
      </svg>
    </div>
